...
public class CalenderDemo {
    public static void main(String[] args) throws InterruptedException {
        ...
        //findElement(By.xpath("a[title='Leave']"));
        leaveButton.click();
        ...
        driver.findElement(By.id("lname")).sendKeys("fix teeth");
        ...
        WebElement nextButton = driver.findElement
                (By.cssSelector("body > div:nth-child(8) > div.xdsoft_datepicker.active > div.xdsoft_monthpicker > button.xdsoft_next"));
